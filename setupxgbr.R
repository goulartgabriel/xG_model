setup.xG.Brasil <- function(rodadas = NULL, imputar = FALSE){
  source("br16.R")
  library(gsheet)
  library(stringr)
  ...
  xG <- gsheet2tbl('https://docs.google.com/spreadsheets/d/1LobEkmNGqp_WLF_vRWqqDWTp5Fz730HwehVwTzYrbPw/edit#gid=239028968')
  xG[,1] = NULL
